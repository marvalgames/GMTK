...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		void AddBoneClipArr(ref BlobBuilder bb, ref BlobArray<BoneClipBlob> bonesBlob, in UnsafeList<RTP.BoneClip> inData, bool userCurves)
		{
		...
		#endif
				//	For user curves make hash32 to be searchable by parameter name
				if (userCurves)
					boneBlob.hash = new Hash128(boneInData.name.CalculateHash32(), 0, 0, 0);
				else
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		void AddAnimationClipBlob(RTP.AnimationClip ac, ref BlobBuilder bb, ref AnimationClipBlob acb)
		{
			...
			AddBoneClipArr(ref bb, ref acb.bones, ac.bones, false);
			AddBoneClipArr(ref bb, ref acb.curves, ac.curves, true);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		unsafe BlobAssetReference<ParameterPerfectHashTableBlob> AddAllParameters(ref BlobBuilder bb, ref ControllerBlob c, RTP.Controller data)
		{
			...
			var rv = CreateParametersPerfectHashTableBlob(hashesArr);
			hashesArr.Dispose();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		void LogAnimatorBakeing(AnimatorBlobAssets aba)
		{
			...
			for (var i = 0; i < cb.layers.Length; ++i)
			{
				...
				Debug.Log($"-> Layer `{l.name.ToFixedString()}` weight: {l.weight}, states count: {l.states.Length}, blend mode: {(int)l.blendingMode}, default state index: {l.defaultStateIndex}");
