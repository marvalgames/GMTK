...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	static AnimationClipBaker()
	{
		humanoidMappingTable = new ()
		{
			...
			// --- Special Bones ---
			{ "RootT.x",						new ParsedCurveBinding() { boneName = SpecialBones.rootMotionBoneName, channelIndex = 0, bindingType = BindingType.Translation, boneType = BoneType.RootCurve }},
			{ "RootT.y",						new ParsedCurveBinding() { boneName = SpecialBones.rootMotionBoneName, channelIndex = 1, bindingType = BindingType.Translation, boneType = BoneType.RootCurve }},
			{ "RootT.z",						new ParsedCurveBinding() { boneName = SpecialBones.rootMotionBoneName, channelIndex = 2, bindingType = BindingType.Translation, boneType = BoneType.RootCurve }},
			{ "RootQ.x",						new ParsedCurveBinding() { boneName = SpecialBones.rootMotionBoneName, channelIndex = 0, bindingType = BindingType.Quaternion, boneType = BoneType.RootCurve }},
			{ "RootQ.y",						new ParsedCurveBinding() { boneName = SpecialBones.rootMotionBoneName, channelIndex = 1, bindingType = BindingType.Quaternion, boneType = BoneType.RootCurve }},
			{ "RootQ.z",						new ParsedCurveBinding() { boneName = SpecialBones.rootMotionBoneName, channelIndex = 2, bindingType = BindingType.Quaternion, boneType = BoneType.RootCurve }},
			{ "RootQ.w",						new ParsedCurveBinding() { boneName = SpecialBones.rootMotionBoneName, channelIndex = 3, bindingType = BindingType.Quaternion, boneType = BoneType.RootCurve }},
		};
	}
}
}
