...
/////////////////////////////////////////////////////////////////////////////////
	...
	void OnDestroy()
	{
		...
		localObjectsQuery.Dispose();
		predictedGhostObjectsQuery.Dispose();
		interpolatedGhostObjectsQuery.Dispose();
	}
...
/////////////////////////////////////////////////////////////////////////////////
	...
	{
	#if RUKHANKA_WITH_NETCODE
		var spawners = spawnerQuery.ToComponentDataArray<SpawnPrefabComponent>(Allocator.Temp);
		...
		var scc = new ServerSpawnPrefabCommand()
		{
			...
			spawnRadius = spawners[0].spawnRadius,
