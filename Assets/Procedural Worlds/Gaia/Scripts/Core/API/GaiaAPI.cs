...
#region Gaia Time Of Day
        ...
        {
            if (GaiaUtils.CheckIfPWSkyExists())
            {
                return PWSkyStandalone.Instance.m_gaiaTimeOfDay;
            }
            return null;
        }
        /// <summary>
        ...
        public static void SetTimeOfDaySettings(GaiaTimeOfDay newGaiaTimeOfDaySettings)
        {
            if (newGaiaTimeOfDaySettings != null)
            {
                if (GaiaUtils.CheckIfPWSkyExists())
                {
                    PWSkyStandalone.Instance.m_gaiaTimeOfDay = newGaiaTimeOfDaySettings;
                    PWSkyStandalone.Instance.UpdateGaiaTimeOfDay(false);
                }
            }
            else
            {
...
//        }
        ...
        public static int GetTimeOfDayHour()
        {
            if (GaiaUtils.CheckIfPWSkyExists())
            {
                return PWSkyStandalone.Instance.m_gaiaTimeOfDay.m_todHour;
            }
        ...
        public static void SetTimeOfDayHour(int newHour)
        {
            if (GaiaUtils.CheckIfPWSkyExists())
            {
                PWSkyStandalone.Instance.m_gaiaTimeOfDay.m_todHour = newHour;
                PWSkyStandalone.Instance.UpdateGaiaTimeOfDay(false);
            }
        }
        /// <summary>
        ...
        public static float GetTimeOfDayMinute()
        {
            if (GaiaUtils.CheckIfPWSkyExists())
            {
                return PWSkyStandalone.Instance.m_gaiaTimeOfDay.m_todMinutes;
            }
        ...
        public static void SetTimeOfDayMinute(float newMinute)
        {
            if (GaiaUtils.CheckIfPWSkyExists())
            {
                PWSkyStandalone.Instance.m_gaiaTimeOfDay.m_todMinutes = newMinute;
                PWSkyStandalone.Instance.UpdateGaiaTimeOfDay(false);
            }
        }
        /// <summary>
        ...
        public static bool GetTimeOfDayEnabled()
        {
            if (GaiaUtils.GetActivePipeline() != GaiaConstants.EnvironmentRenderer.HighDefinition)
            {
                if (GaiaUtils.CheckIfPWSkyExists())
                {
                    return PWSkyStandalone.Instance.m_gaiaTimeOfDay.m_todEnabled;
                }
            }
            return false;
        }
        ...
        public static void SetTimeOfDayEnabled(bool timeOfDayEnabled)
        {
            if (GaiaUtils.CheckIfPWSkyExists())
            {
                PWSkyStandalone.Instance.m_gaiaTimeOfDay.m_todEnabled = timeOfDayEnabled;
                PWSkyStandalone.Instance.UpdateGaiaTimeOfDay(false);
            }
        }
        /// <summary>
        ...
        public static float GetTimeOfDayTimeScale()
        {
            if (GaiaUtils.CheckIfPWSkyExists())
            {
                return PWSkyStandalone.Instance.m_gaiaTimeOfDay.m_todDayTimeScale;
            }
            return 0;
        }
        /// <summary>
        ...
        public static void SetTimeOfDayTimeScale(float newTimeScale)
        {
            if (GaiaUtils.CheckIfPWSkyExists())
            {
                PWSkyStandalone.Instance.m_gaiaTimeOfDay.m_todDayTimeScale = newTimeScale;
                PWSkyStandalone.Instance.UpdateGaiaTimeOfDay(false);
            }
        }
#endif
