...
Shader "Terrain_0_0_b99067c5-3ca4-472c-a942-0a6163051f29_TerrainObjectBlend"
{
   Properties
   {
      ...
      // snow noise
      [NoScaleOffset]_SnowNormalNoise("Noise Normal", 2D) = "bump" {}
      _SnowNormalNoiseScaleStrength("Noise Params", Vector) = (0.1, 0.5, 0, 0)
   ...
   SubShader
   {
            Tags {"RenderPipeline" = "UniversalPipeline"  "RenderType" = "UniversalLitShader" "Queue" = "Transparent+100" "IgnoreProjector" = "False"  "TerrainCompatible" = "true" "SplatCount" = "4"}
...
ZWrite Off
   ...
   #pragma fragment Frag
      ...
      #define _SNOWNORMALNOISE 1
      #define _SNOWWORLDSPACEUV 1
      #define _SNOWSPARKLE 1
      #define _SNOWRIM 1
      #define _WETNESS 1
      #define _PUDDLES 1
      #define _STREAMS 1
