...
Shader "Terrain_0_0_b99067c5-3ca4-472c-a942-0a6163051f29"
{
   Properties
   {
   ...
   SubShader
   {
            Tags {"RenderPipeline" = "UniversalPipeline"  "RenderType" = "UniversalLitShader" "Queue" = "Geometry+100" "IgnoreProjector" = "False" "SplatCount" = "4"}
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/Terrain_0_0_b99067c5-3ca4-472c-a942-0a6163051f29_Base1893441177"
   Fallback "Hidden/Terrain_0_0_b99067c5-3ca4-472c-a942-0a6163051f29_Base1893441177"
